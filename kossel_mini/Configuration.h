...
#define STRING_CONFIG_H_AUTHOR "(Junior Tada, github config)"  // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Junior Kossel"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 235.5        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 223.65             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -3.08, -3.37 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 118.92              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -1.80, +0.01, +1.79 } // (mm) Get these values from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 600 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 15, -2 }
