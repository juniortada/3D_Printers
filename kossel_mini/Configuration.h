...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 237.3       // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 217.5            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 111.6              // (mm) Get this value from G33 auto calibrate
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 9000, 9000, 9000, 10000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 15, -8, 0 }
